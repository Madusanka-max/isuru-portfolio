...
const services = [
  ...
  },
  {
    ...
    description: 'Creating engaging and high-quality content for various platforms.',
        ...
        >
          {services.map((service, index) => (
            <div key={index} className="flex-1 flex flex-col justify-center gap-6 group">
              ...
              {/* description */}
              <p className=" text-white/60  group-hover:text-teal-100 transition-all duration-500">{service.description}</p>
              {/* border */}
